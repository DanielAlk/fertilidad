...
class PracticesControllerTest < ActionController::TestCase
  ...
  test "should create practice" do
    assert_difference('Practice.count') do
      post :create, practice: { info: @practice.info, practice_type_id: @practice.practice_type_id, title: @practice.title }
    end
  ...
  test "should update practice" do
    patch :update, id: @practice, practice: { info: @practice.info, practice_type_id: @practice.practice_type_id, title: @practice.title }
    assert_redirected_to practice_path(assigns(:practice))
  end
